...
function addMember() {
    ...
    newMemberDetails.innerHTML = `
        <h5>HH Member Details</h5>
            ...
            <div class="col-sm-12">
                <input type="text" class="form-control" id="hh_member${memberCount}" name="hh_member${memberCount}" placeholder="Enter HH Member" maxlength="100" required="">
            </div>

            <div class="form-group">
            <label for="surname" class="col-sm-8 control-label">Surname</label>
            <div class="col-sm-12">
                <input type="text" class="form-control" id="surname${memberCount}" name="surname${memberCount}" placeholder="Enter Surname" maxlength="100" required="">
            </div>
            </div>
            ...
            <div class="col-sm-12">
                <input type="text" class="form-control" id="firstname${memberCount}" name="firstname${memberCount}" placeholder="Enter First Name" maxlength="100" required="">
            </div>
            </div>
            ...
            <div class="col-sm-12">
                <input type="text" class="form-control" id="middlename${memberCount}" name="middlename${memberCount}" placeholder="Enter Middle Name" maxlength="100" required="">
            </div>
            </div>
            ...
            <div class="col-sm-12">
                <select class="form-control" id="gender${memberCount}" name="gender${memberCount}" required="">
            ...
            <div class="col-sm-12">
                <input type="number" class="form-control" id="age${memberCount}" name="age${memberCount}" placeholder="Enter Age" required="">
            </div>
            </div>
