    ...
    {  
        ...
        $assistance   =   Assistance::updateOrCreate(
            ...
            'conform_marketing' => $request->conform_marketing,
              ...
              'imageUpload1' => $request->imageUpload1,
              'imagePreviewContainer1' => $request->imagePreviewContainer1,
              'imagePreview1' => $request->imagePreview1,
              'imageUpload2' => $request->imageUpload2,
              'imagePreviewContainer2' => $request->imagePreviewContainer2,
              'imagePreview2' => $request->imagePreview2,
...
'imagePreviewContainer1' => $assistances->imagePreviewContainer1,
'imagePreview1' => $assistances->imagePreview1,
'imageUpload2' => $assistances->imageUpload2,
'imagePreviewContainer2' => $assistances->imagePreviewContainer2,
'imagePreview2' => $assistances->imagePreview2,
       ...
       $assistances = Assistance::create([
        'rsbsa' => $archivedassistances->rsbsa,
            ...
            'conform_marketing' => $archivedassistances->conform_marketing,
              ...
              'imagePreviewContainer1' => $archivedassistances->imagePreviewContainer1,
              'imagePreview1' => $archivedassistances->imagePreview1,
              'imageUpload2' => $archivedassistances->imageUpload2,
              'imagePreviewContainer2' => $archivedassistances->imagePreviewContainer2,
              'imagePreview2' => $archivedassistances->imagePreview2,
