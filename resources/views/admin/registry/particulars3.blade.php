...
<div class="form-group">
  ...
  <div class="col-sm-13">
    <input type="number" class="form-control" id="geographic_coordinates3" name="geographic_coordinates3" placeholder="Enter Geographic Coordinates" maxlength="255" >
  </div>
</div>
    ...
    <label class="col-sm-8 control-label">Tenure type:</label>
      <div class="col-sm-12">
        ...
        <div class="form-group form-check">
            <input type="checkbox" id="ownedCheckbox3" class="form-check-input" name="tenure3" value="Owned3" onclick="handleCheckboxChange3(this.value)">
            <label for="ownedCheckbox3" class="form-check-label">Owned</label>
        </div>

        <div class="form-group form-check">
            <input type="checkbox" id="rentCheckbox3" class="form-check-input" name="tenure3" value="Rent3" onclick="handleCheckboxChange3(this.value)">
        ...
        <div class="form-group form-check">
            <input type="checkbox" id="tenantCheckbox3" class="form-check-input" name="tenure3" value="Tenant3" onclick="handleCheckboxChange3(this.value)">
            <label for="tenantCheckbox3" class="form-check-label">Tenant</label>
        </div>

        <div class="form-group form-check">
            <input type="checkbox" id="othersCheckbox3" class="form-check-input" name="tenure3" value="Others3" onclick="handleCheckboxChange3(this.value)">
...
<div class="form-group">
  ...
  <div class="col-sm-13">
    <input type="number" class="form-control" name="hectares3" name="hectares3" placeholder="Enter Area(Hectares)" maxlength="100" >
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-sm-13">
      <div class="form-group form-check">
          <input type="checkbox" id="flatCheckbox3" class="form-check-input" name="land3" value="Flat3" onclick="handleLandTypeChange3('Flat3')">
          <label for="flatCheckbox3" class="form-check-label">Flat</label>
      </div>

      <div class="form-group form-check">
          <input type="checkbox" id="gentlySlopingCheckbox3" class="form-check-input" name="land3" value="Gently Sloping3" onclick="handleLandTypeChange3('Gently Sloping3')">
          <label for="gentlySlopingCheckbox3" class="form-check-label">Gently Sloping</label>
      </div>

      <div class="form-group form-check">
          <input type="checkbox" id="rollingUndulatingCheckbox3" class="form-check-input" name="land3" value="Rolling/Undulating3" onclick="handleLandTypeChange3('Rolling/Undulating3')">
          <label for="rollingUndulatingCheckbox3" class="form-check-label">Rolling/Undulating</label>
      </div>

      <div class="form-group form-check">
          <input type="checkbox" id="hillySteepSlopesCheckbox3" class="form-check-input" name="land3" value="Hilly/Steep Slopes3" onclick="handleLandTypeChange3('Hilly/Steep Slopes3')">
...
<div class="form-group">
  ...
  <div class="col-sm-13">
    <div class="checkbox">
      <label>
        <input type="checkbox" id="irrigated3" name="source3" value="Irrigated3" onclick="handleWaterSourceChange3('Irrigated3')"> Irrigated
      </label>
    </div>
    <div class="checkbox">
      <label>
        <input type="checkbox" id="swip3" name="source3" value="SWIP/SIS3" onclick="handleWaterSourceChange3('SWIP/SIS3')"> SWIP/SIS
      </label>
    </div>
    <div class="checkbox">
      <label>
        <input type="checkbox" id="pump3" name="source3" value="Water Pump3" onclick="handleWaterSourceChange3('Water Pump3')"> Water Pump
      </label>
    </div>
   
    <div class="checkbox">
      <label>
        <input type="checkbox" id="rainfed3" name="source3" value="Rainfed3" onclick="handleWaterSourceChange3('Rainfed3')"> Rainfed
      </label>
    </div>
  </div>
</div>
