<div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-12">
      <input type="number" class="form-control" id="geographic_coordinates2" name="geographic_coordinates2" placeholder="Enter Geographic Coordinates" maxlength="255" >
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-12">
      <input type="number" class="form-control" id="tax_declaration_no2" name="tax_declaration_no2" placeholder="Enter Tax Declaration No" maxlength="100" >
    </div>
  </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-12">
          ...
          <div class="form-group form-check">
              <input type="checkbox" id="ownedCheckbox2" class="form-check-input" name="tenure2" value="Owned2" onclick="handleCheckboxChange2(this.value)">
              <label for="ownedCheckbox2" class="form-check-label">Owned</label>
          </div>
  
          <div class="form-group form-check">
              <input type="checkbox" id="rentCheckbox2" class="form-check-input" name="tenure2" value="Rent2" onclick="handleCheckboxChange2(this.value)">
          ...
          <div class="form-group form-check">
              <input type="checkbox" id="tenantCheckbox2" class="form-check-input" name="tenure2" value="Tenant2" onclick="handleCheckboxChange2(this.value)">
              <label for="tenantCheckbox2" class="form-check-label">Tenant</label>
          </div>
  
          <div class="form-group form-check">
              <input type="checkbox" id="othersCheckbox2" class="form-check-input" name="tenure2" value="Others2" onclick="handleCheckboxChange2(this.value)">
...
<div class="form-group">
    ...
    <div class="col-sm-12">
      <input type="number" class="form-control" name="hectares2" name="hectares2" placeholder="Enter Area(Hectares)" maxlength="100" >
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-12">
        <div class="form-group form-check">
            <input type="checkbox" id="flatCheckbox2" class="form-check-input" name="land2" value="Flat2" onclick="handleLandTypeChange2('Flat2')">
            <label for="flatCheckbox2" class="form-check-label">Flat</label>
        </div>

        <div class="form-group form-check">
            <input type="checkbox" id="gentlySlopingCheckbox2" class="form-check-input" name="land2" value="Gently Sloping2" onclick="handleLandTypeChange2('Gently Sloping2')">
            <label for="gentlySlopingCheckbox2" class="form-check-label">Gently Sloping</label>
        </div>

        <div class="form-group form-check">
            <input type="checkbox" id="rollingUndulatingCheckbox2" class="form-check-input" name="land2" value="Rolling/Undulating2" onclick="handleLandTypeChange2('Rolling/Undulating2')">
            <label for="rollingUndulatingCheckbox2" class="form-check-label">Rolling/Undulating</label>
        </div>

        <div class="form-group form-check">
            <input type="checkbox" id="hillySteepSlopesCheckbox2" class="form-check-input" name="land2" value="Hilly/Steep Slopes2" onclick="handleLandTypeChange2('Hilly/Steep Slopes2')">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-12">
      <div class="checkbox">
        <label>
          <input type="checkbox" id="irrigated2" name="source2" value="Irrigated2" onclick="handleWaterSourceChange2('Irrigated2')"> Irrigated
        </label>
      </div>
      <div class="checkbox">
        <label>
          <input type="checkbox" id="swip2" name="source2" value="SWIP/SIS2" onclick="handleWaterSourceChange2('SWIP/SIS2')"> SWIP/SIS
        </label>
      </div>
      <div class="checkbox">
        <label>
          <input type="checkbox" id="pump2" name="source2" value="Water Pump2" onclick="handleWaterSourceChange2('Water Pump2')"> Water Pump
        </label>
      </div>
     
      <div class="checkbox">
        <label>
          <input type="checkbox" id="rainfed2" name="source2" value="Rainfed2" onclick="handleWaterSourceChange2('Rainfed2')"> Rainfed
        </label>
      </div>
    </div>
  </div>
